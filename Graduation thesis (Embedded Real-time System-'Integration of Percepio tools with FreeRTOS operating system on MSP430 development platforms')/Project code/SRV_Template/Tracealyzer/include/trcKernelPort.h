 ...
 */
#define TRACE_GET_TASK_FILTER(pxTask) prvTraceGetTaskNumberLow16((void*)pxTask)
 ...
 */
#define TRACE_SET_TASK_FILTER(pxTask, group) prvTraceSetTaskNumberLow16((void*)pxTask, group)
 ...
 */
#define TRACE_GET_QUEUE_FILTER(pxQueue) prvTraceGetQueueNumberLow16((void*)pxQueue)
